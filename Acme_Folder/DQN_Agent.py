...
import trfl
from Acme_Folder import FeedForward, DQN_Learner

FeedForwardActor2 = FeedForward.FeedForwardActor2
DQNLearner2 = DQN_Learner.DQNLearner2

class DQN2(agent.Agent):
  """DQN agent.
  ...
  def __init__(
      ...
      batch_size: int = 256,
      prefetch_size: int = 4,
      target_update_period: int = 50, #100
      samples_per_insert: float = 32.0,
      min_replay_size: int = 100,  #1000
      max_replay_size: int = 100000,  # 1000000
    ...
    #print('DQN2: Logger Received {}'.format(logger))
    #logger.write({'Test': "test from DQN2"})
